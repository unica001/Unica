...
+ (NSDate *)getUTCTime:(NSDate *)date  // Get UTC date from given date
{
...
+ (NSDate *)getLocalDateFromUtc:(NSDate *)date  // Get local date from give UTC date
{
    NSTimeZone *tz = [NSTimeZone defaultTimeZone];
    NSInteger seconds = [tz secondsFromGMTForDate:date];
    return [NSDate dateWithTimeInterval:seconds sinceDate: date];
...
+ (BOOL)date:(NSDate *)date isBetweenDate:(NSDate *)beginDate andDate:(NSDate *)endDate // Date exist between two date
{
