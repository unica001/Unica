...
-(UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section{
    ...
    if (section == UNKFinantialSupportType) { // add line below finantial support last row
        ...
        [footerView addSubview:lineView];
         ...
         UIButton *btn = [self getbutton:CGRectMake(kiPhoneWidth-110, 7, 90, 66) font:[UIFont fontWithName:kFontSFUITextRegular size:11] color:[UIColor orangeColor] text:@""];
        [btn setBackgroundImage:[UIImage imageNamed:@"addFile"] forState:UIControlStateNormal];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == UNKFinantialSupportType) {
        ...
        cell.textInputData.inputAccessoryView = [self addToolBarOnKeyboard:indexPath.row];
        ...
        cell.CourseStartTextField.inputAccessoryView = [self addToolBarOnKeyboard:indexPath.row];
        cell.CourseCompleteTextField.inputAccessoryView = [self addToolBarOnKeyboard:indexPath.row];
...
//        }
        ...
        NSString *rowTag = [NSString stringWithFormat:@"%ld%ld",(long)indexPath.section,indexPath.row];
         ...
         cell.textField.inputAccessoryView = [self addToolBarOnKeyboard:[rowTag doubleValue]];
 ...
 * version no :- 1.0
 ****************************/
-(UIToolbar *)addToolBarOnKeyboard :(double) tag{
                ...
                else if ([examName isEqualToString:@"GMAT"])
                {
                    ...
                    for(int i=0;i<9;i++)
                    {
                        ...
                        else if(i==6)
                        {
                            [keyValue setValue:@"Writing%" forKey:@"name"];
                            [keyValue setValue:[[scoreArray objectAtIndex:5]valueForKey:@"score"] forKey:@"value"];
                            [keyValue setValue:@"" forKey:@"value"];
                        }
                        else if(i==7)
                        {
        ...
        for(int i=0;i<education.count;i++)
        {
            ...
            for(int j=0;j<dataArray.count;j++)
            {
                if([Utility replaceNULL:[[dataArray objectAtIndex:j] valueForKey:kValue] value:@""].length == 0) {
                    if(j==0)
                    {
                        failedMessage =[NSString stringWithFormat:@"Please select Highest education level"] ;
                    }
                    else if(j==1)
                    {
                    ...
                    {
                        failedMessage =[NSString stringWithFormat:@"Please enter primary language of institute"] ;
                    }
                    else if(j==8)
                    {
        ...
        if (validScore.count == 0 && [[Utility replaceNULL:[step4SelectedDataDictionaty valueForKey:kValid_scores] value:@""] isEqualToString:@"true"]) {
            ...
            for(int i=0; i< validScore.count;i++)
            {
                ...
                if([title isEqualToString:@"IELTS"])
                {
                    ...
                    NSInteger listening=0,reading=0,writing=0,speaking=0;
                    
                    if(filterArray.count>0)
                    {
                        listening =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:1] valueForKey:kValue] integerValue];
                        reading =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:2] valueForKey:kValue]integerValue];
                        writing =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:3] valueForKey:kValue]integerValue];
                        speaking =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:4] valueForKey:kValue]integerValue];
                        ...
                        if(listening>=10 ||listening<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid listening score (0-9) for %@ exam.", title] ;
                        }
                        else if(reading>=10 ||reading<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid reading score (0-9) for %@ exam.", title] ;
                        }
                        else if(writing>=10 ||writing<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writing score (0-9) for %@ exam.", title] ;
                        }
                        else if(speaking>=10||speaking<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid speaking score (0-9) for %@ exam.", title] ;
                        }
                ...
                else if ([title isEqualToString:@"TOEFL IBT"])
                {
                    ...
                    if(filterArray.count>0)
                    {
                        ...
                        if(listening>=31 ||listening<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid listening score (0-30) for %@ exam.", title] ;
                        }
                        else if(reading>=31||reading<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid reading score (0-30) for %@ exam.", title] ;
                        }
                        else if(writing>=31 ||writing<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writing score (0-30) for %@ exam.", title] ;
                        }
                        else if(speaking>=31||speaking<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid speaking score (0-30) for %@ exam.", title] ;
                        }
                ...
                else if ([title isEqualToString:@"TOEFL CBT"])
                {
                    ...
                    if(filterArray.count>0)
                    {
                        ...
                        if(listening<113  ||listening>300)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid listening score (113-300) for %@ exam.", title] ;
                        }
                        else if(reading<113  ||reading>300)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid reading score (113-300) for %@ exam.", title] ;
                        }
                        else if(writing<113  ||writing>300 )
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writing score (113-300) for %@ exam.", title] ;
                        }
                        else if(speaking<113  ||speaking>300)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid speaking score (113-300) for %@ exam.", title] ;
                        }
                    }
                ...
                else if ([title isEqualToString:@"PTE"])
                {
                    ...
                    if(filterArray.count>0)
                    {
                        ...
                        if(listening<0  ||listening>91)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid listening score (0-90) for %@ exam.", title] ;
                        }
                        else if(reading<0  ||reading>91)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid reading score (0-90) for %@ exam.", title] ;
                        }
                        else if(writing<0  ||writing>91 )
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writing score (0-90) for %@ exam.", title] ;
                        }
                        else if(speaking<0  ||speaking>91)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid speaking score (0-90) for %@ exam.", title] ;
                        }
                    }
                ...
                else if ([title isEqualToString:@"GRE"])
                {
                    NSPredicate * predicate = [NSPredicate predicateWithFormat:@"sub_title = %@",title ];
                    NSArray *filterArray = [validScore filteredArrayUsingPredicate:predicate];
                    NSInteger verbal=0,verbalp=0,quant=0,quantp=0,anal=0,analyp=0;
                    
                    if(filterArray.count>0)
                    {
                        verbal =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:1] valueForKey:kValue] integerValue];
                        verbalp =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:2] valueForKey:kValue]integerValue];
                        quant =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:3] valueForKey:kValue]integerValue];
                        quantp =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:4] valueForKey:kValue]integerValue];
                        anal =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:5] valueForKey:kValue] integerValue];
                        analyp =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:6] valueForKey:kValue]integerValue];
                        
                        if(verbal<130 || verbal>170)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid verbal score (130-170) for %@ exam.", title] ;
                        }
                        else if(verbalp<0 || verbalp>100)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid verbal percentage (0-100) for %@ exam.", title] ;
                        }
                        else if(quant<130 || quant>170)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid quantitative score (130-170) for %@ exam.", title] ;
                        }
                        else if(quantp<0 || quantp>100)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid quantitative percentage (0-100) for %@ exam.", title] ;
                        }
                        else if(anal<0 || anal>6)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid analytical score for %@ exam.", title] ;
                        }
                        else if(analyp<0 || analyp>100)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid analytical percentage for %@ exam.", title] ;
                        }
                    }
                ...
                else if ([title isEqualToString:@"GMAT"])
                {
                    ...
                    if(filterArray.count>0)
                    {
                        NSInteger verbal=0,verbalp=0,quant=0,quantp=0,anal=0,analyp=0,total,totalp;
                        ...
                        anal =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:5] valueForKey:kValue] integerValue];
                        analyp =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:6] valueForKey:kValue]integerValue];
                        total =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:7] valueForKey:kValue]integerValue];
                        totalp =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:8] valueForKey:kValue]integerValue];
                        ...
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writting score (0-6) for %@ exam.", title] ;
                        }
                        else if(analyp<0 || analyp>100)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writting percentage (0-100) for %@ exam.", title] ;
                        }
                        else if(total<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid total score for %@ exam.", title] ;
                        }
                        else if(totalp<0 || totalp>100)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid toatl percentage (0-100) for %@ exam.", title] ;
                        }
                ...
                else if ([title isEqualToString:@"SAT"])
                {
                    ...
                    if(filterArray.count>0)
                    {
                        NSInteger raw=0,math=0,rading=0,writting=0,language=0;
                        
                        raw =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:1] valueForKey:kValue] integerValue];
                        math =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:2] valueForKey:kValue]integerValue];
                        rading =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:3] valueForKey:kValue]integerValue];
                        writting =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:4] valueForKey:kValue]integerValue];
                        language =[[[[[filterArray objectAtIndex:0] valueForKey:@"data"] objectAtIndex:5] valueForKey:kValue] integerValue];
                        ...
                        if(raw<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid raw score for %@ exam.", title] ;
                        }
                        else if(math<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid math score for %@ exam.", title] ;
                        }
                        else if(rading<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid rading score for %@ exam.", title] ;
                        }
                        else if(writting<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid writting score for %@ exam.", title] ;
                        }
                        else if(language<1)
                        {
                            failedMessage =[NSString stringWithFormat:@"Please enter valid language score for %@ exam.", title] ;
                        }
